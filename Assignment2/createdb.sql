...
insert into Complimented_Friends values('Y1','Y2','Nice');
insert into Complimented_Friends values('Y2','Y1','Good');
insert into Complimented_Friends values('Y4','Y7','Wonderful');
insert into Complimented_Friends values('Y6','Y2','Good');
insert into Complimented_Friends values('Y7','Y1','Wonderful');
insert into Complimented_Friends values('Y8','Y10','Nice');
insert into Complimented_Friends values('Y9','Y1','Wonderful');
insert into Complimented_Friends values('Y11','Y12','Wonderful');
insert into Complimented_Friends values('Y12','Y11','Nice');
insert into Complimented_Friends values('Y13','Y8','Good');

insert into Photo values('P1','Scenic','CA');
insert into Photo values('P2','Scenic','CA');
insert into Photo values('P3','Scenic','CA');
insert into Photo values('P4','Scenic','CA');
insert into Photo values('P5','Scenic','CA');
insert into Photo values('P6','Scenic','CA');
insert into Photo values('P7','Scenic','CA');
insert into Photo values('P8','Scenic','CA');
insert into Photo values('P9','Scenic','CA');
insert into Photo values('P10','Scenic','CA');
insert into Photo values('P11','Scenic','CA');
insert into Photo values('P12','Scenic','CA');
insert into Photo values('P13','Scenic','CA');
insert into Photo values('P14','Scenic','CA');
...
INSERT INTO list_of_user VALUES (
compliment_type('Y1','Y2','Nice'));
INSERT INTO list_of_user VALUES (
compliment_type('Y2','Y1','Good'));
INSERT INTO list_of_user VALUES (
compliment_type('Y4','Y7','Wonderful'));
INSERT INTO list_of_user VALUES (
compliment_type('Y6','Y2','Good'));
...
recommended_type('R1','2','Y1','February 3,1993','R'));
INSERT INTO review_table VALUES (
recommended_type('R2','5','Y2','February 3,1993','R'));
INSERT INTO review_table VALUES (
recommended_type('R3','3','Y3','February 3,1993','R'));
INSERT INTO review_table VALUES (
recommended_type('R4','4','Y4','February 3,1993','R'));
